...
export const Experience = () => {
    ...
    return (
        <>
            ...
            <group ref={cameraGroup}>
                ...
                <group ref={airplane}>
                    <Float floatIntensity={2} speed={2}>
                        <Airplane rotation-y={Math.PI / 2} scale={[0.5, 0.5, 0.5]} position-y={0.2} position-z={1} />
                    </Float>
                </group>
            </group>
            ...
            {/* <Float floatIntensity={2} speed={2} enabled={false}> */}
            <Float floatIntensity={2} speed={2} enabled={scroll.offset > 0.1 ? false : true}>
                <Plant01
                    opacity={0.95}
            ...
            <Plant01 opacity={0.93} scale={[0.08, 0.08, 0.08]} position={[-6.5, -1, -8]} rotation={[0, 0, 0]} />

            <Plant01 opacity={0.95} scale={[0.1, 0.1, 0.1]} position={[2.5, -0.5, -2]} rotation={[0, 0, 0]} />
      ...
      /> */}
            ...
            <Plant01 opacity={0.97} scale={[0.2, 0.2, 0.2]} position={[-1, -1, -53]} rotation={[0, 0, 0]} />
